...
function getStartText() {
  return [
    ...
    `Я бот студии балета и растяжки LEVITA (${config.studioCity})`,
    '',
    'Начни путь к гибкости, красивой осанке и лёгкости в теле 💫',
    'Без подготовки — в комфортной и поддерживающей атмосфере.',
    '',
    `Продолжая использование, вы даёте [согласие](${config.privacyPolicyUrl}) на обработку персональных данных.`,
  ].join('\n');
}
